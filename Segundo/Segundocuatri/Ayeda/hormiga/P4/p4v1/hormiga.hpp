...
class HormigaC: public Hormiga {
  public:
    HormigaC(Mundo world);
    HormigaC(Mundo world, int xpos, int ypos, int direc);
    HormigaC(Mundo world, char random);
    ~HormigaC();
...
class HormigaD: public Hormiga {
  public:
    HormigaD(Mundo world);
    HormigaD(Mundo world, int xpos, int ypos, int direc);
    HormigaD(Mundo world, char random);
    ~HormigaD();
