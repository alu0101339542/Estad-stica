...
HormigaC::HormigaC(Mundo world, int xpos, int ypos, int direc) {
  Setx(xpos);
  Sety(ypos);
  Setdir(direc);
}
HormigaC::HormigaC(Mundo world, char random){
  int xmax = world.Getsizex();
  int ymax = world.Getsizey();
  Setx(rand() % xmax);
  Sety(rand() % ymax);
...
HormigaD::HormigaD(Mundo world, int xpos, int ypos, int direc) {
  Setx(xpos);
  Sety(ypos);
  Setdir(direc);
}
HormigaD::HormigaD(Mundo world, char random){
  int xmax = world.Getsizex();
  int ymax = world.Getsizey();
  Setx(rand() % xmax);
  Sety(rand() % ymax);
